...
[good first issue](https://github.com/animicaorg/perbug/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/animicaorg/perbug/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
...
For all other issues and pull requests, the https://github.com/animicaorg/perbug node repository should be used.
...
[Translation Process](https://github.com/animicaorg/perbug/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/animicaorg/perbug  # Fetch the latest upstream commit
...
https://github.com/animicaorg/perbug/pull/16189).
