Bitcoin Core version 0.19.0.1 is now available from:
  ...
  <https://bitcoincore.org/bin/perbug-core-0.19.0.1/>
...
- #15896 feature_filelock, interface_perbug_cli: Use PACKAGE_NAME in messages rather than hardcoding Bitcoin Core (luke-jr)
